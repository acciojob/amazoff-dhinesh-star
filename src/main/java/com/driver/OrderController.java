...
public class OrderController {
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        ...
        String response = orderService.addPartner(deliveryPartner);
    ...
    public ResponseEntity<DeliveryPartner> getPartnerById(@PathVariable String partnerId){
        ...
        //deliveryPartnerFindingWithOrderIdDB should contain the value given by partnerId
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable("time") String time, @PathVariable("partnerId") String partnerId){
        ...
        int timeReq=hrs*60+mins;
        //countOfOrders that are left after a particular time of a DeliveryPartner
        countOfOrders = orderService.getOrdersLeftAfterGivenTimeByPartnerId(timeReq,partnerId);
        return new ResponseEntity<>(countOfOrders, HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
        String time = null;
        int timeInMins = orderService.getLastDeliveryTimeByPartnerId(partnerId);
        //Return the time when that partnerId will deliver his last delivery order.
        StringBuilder sb = new StringBuilder();
        sb.append(timeInMins/60).append(":").append(timeInMins%60);
        time=sb.toString();
    ...
    public ResponseEntity<String> deleteOrderById(@PathVariable String orderId){
        ...
        String resp = orderService.deleteOrderById(orderId);
